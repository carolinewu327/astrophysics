...
pairs is anisotropic. The band difference in Equation~(\ref{eq:band}) measures
the contrast between the axial and perpendicular residuals.
...
observed and simulated residual maps. The observed maps contain a broad
axis-aligned excess and an off-axis deficit, although both features have low
